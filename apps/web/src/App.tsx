...
function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-bg text-text">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_right,_hsl(var(--color-accent)_/_0.18),_transparent_50%)]" />
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(140deg,_transparent_0%,_hsl(var(--color-accent-soft)_/_0.28)_100%)]" />
      ...
      <div className="mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-5 p-shell lg:grid-cols-[var(--space-sidebar)_1fr]">
        <aside className="panel animate-shellIn p-5">
          <div className="mb-5 flex items-center justify-between">
            <h2 className="font-display text-base font-semibold">Navigation</h2>
            <span className="h-2.5 w-2.5 rounded-full bg-status-on-mission shadow-[0_0_0_6px_hsl(var(--status-on-mission)_/_0.2)] animate-pulseSoft" />
          </div>
        ...
        <main className="space-y-5">
          <section className="panel animate-shellIn p-5 [animation-delay:80ms]">
          ...
          <section className="panel animate-shellIn p-5 [animation-delay:140ms]">
